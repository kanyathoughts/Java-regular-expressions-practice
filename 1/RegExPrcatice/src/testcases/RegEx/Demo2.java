...
public class Demo2 {
	...
	public static void main(String[] args) {
		...
		String groupPatternString = "(<h2>.*?</h2>)"; //if we add .* then * is greedy quantifier it will not stop whenever it will see </h2> still it will check so to stop that 
		//we have to convert that greedy quantifier to lazy quantifier by adding ? after the *. It will stop whenever it will find </h2> and proceed to find <h2>.
