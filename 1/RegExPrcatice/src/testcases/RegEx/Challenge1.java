...
public class Challenge1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("challenge5: " + challenge5.matches("\\D+")); //non digits
		System.out.println("challenge5: " + challenge5.matches("[abcdefg]+"));
		System.out.println("challenge5: " + challenge5.replaceAll("[abcdefg]+", "Kanya"));
		
		String challenge6 = "abcd.123";
		System.out.println("challenge6: " + challenge6.matches("\\D+\\.\\d+")); //we have to put "\\." because . will act as all characters so to escape that we have to give "\\."
		System.out.println("should fail: " + "f6.6g".matches("\\D+\\.\\d+"));
	}
